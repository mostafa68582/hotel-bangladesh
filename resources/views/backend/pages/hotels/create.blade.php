                                    ...
                                    <div class="data_input">
                                            <div class="row input_row">
                                                ...
                                                <div class="col-12 col-sm-12 col-md-3">
                                                    ...
                                                    <br>
                                                    <input class="data_field_input_tag" type="text" id="available" placeholder="Enter User phone">
                                                </div>
                                                <div class="col-12 col-sm-12 col-md-3">
                                                    <label class="input_field_name" for="status">hotel email</label>
                                                    <br>
                                                    <input class="data_field_input_tag" type="email" id="hotel-email" placeholder="Enter hotel email">
                                                </div>
                                            </div>
                                            <div class="row input_row">
                                                <div class="col-12 col-sm-12 col-md-3">
                                                    ...
                                                    <br>
                                                    <input class="data_field_input_tag" type="text" id="user-email" placeholder="Enter user email">
                                                </div>
                                                <div class="col-12 col-sm-12 col-md-3">
                                                    <label class="input_field_name" for="type_name">Website url</label>
                                                    <br>
                                                    <input class="data_field_input_tag" type="text" id="web-url" placeholder="Enter website url">
                                                </div>
                                                <div class="col-12 col-sm-12 col-md-3">
                                                    <label class="input_field_name" for="cost_pre_day">Location</label>
                                                    <br>
                                                    <input class="data_field_input_tag" type="text" id="location" placeholder="Hotel Location">
                                                </div>
                                                <div class="col-12 col-sm-12 col-md-3">
                                                    <label class="input_field_name" for="discount">Street address</label>
                                                    <br>
                                                    <input class="data_field_input_tag" type="text" id="street-address" placeholder="Discount">
                                                </div>
                                            </div>
                                            <div class="row input_row">
                                                <div class="col-12 col-sm-12 col-md-3">
                                                    ...
                                                    <br>
                                                    <input class="data_field_input_tag" type="text" id="country" placeholder="Enter country">
                                                </div>
                                                <div class="col-12 col-sm-12 col-md-3">
                                                    <label class="input_field_name" for="max_adult">City</label>
                                                    <br>
                                                    <input class="data_field_input_tag" type="text" id="city" placeholder="Enter city">
                                                </div>
                                                <div class="col-12 col-sm-12 col-md-3">
                                                    <label class="input_field_name" for="max_guest">zip code</label>
                                                    <br>
                                                    <input class="data_field_input_tag" type="text" id="zip-code" placeholder="Enter zip code">
                                                </div>
                                                <div class="col-12 col-sm-12 col-md-3">
                                                    <label class="input_field_name" for="max_guest">District</label>
                                                    <br>
                                                    <input class="data_field_input_tag" type="text" id="district" placeholder="Enter district">
                                                </div>
                                            </div>
                                             ...
                                             <div class="row input_row">
                                                <div class="col-12 col-sm-12 col-md-3">
                                                    ...
                                                    <br>
                                                    <input class="data_field_input_tag" type="text" id="thana" placeholder="Enter thana">
                                                </div>
                                                <div class="col-12 col-sm-12 col-md-3">
                                                    <label class="input_field_name" for="star_rating">Star rating</label>
                                                    <br>
                                                    <input class="data_field_input_tag" type="number" id="star-rating" placeholder="Enter Star rating">
                                                </div>
                                                <div class="col-12 col-sm-12 col-md-3">
