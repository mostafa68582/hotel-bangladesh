...
@push('style')
<link rel="stylesheet" type="text/css" href="{{asset('backend/assets/css/allHotelPage.css')}}"> <!--===== style.css link =====-->
@endpush
@section('content')
                    ...
                    <div class="row"> <!--========== room booking head start ==========-->
                        <div class="col-6">
                            <div class="data_heading">
                                <h3>all hotels</h3>
                                <h4><span class="data_text"><a href="#">Database</a></span> / <span class="add_text">all hotels</span></h4>
                            </div>
                        </div>
                            ...
                            <div class="row room_booking_row">
                                ...
                                <div class="col-12 col-sm-6 col-md-3">
                                    <div class="das_room_button">
                                        <a href="#" class="stop_scrolling" data-user-code="@(user.Code)"><button class="room_das_btn">SEARCH</button></a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-12 col-sm-6 col-md-3">
                                    <div class="hotel_contents_wrap">
                                        <div class="hotel_contents">
                                            <li class="all_hotel_more_opt_icon mor_opt_icon_li"><i class="fas fa-ellipsis-v"></i>
                                                <div class="more_opt">
                                                    <ul>
                                                        <li>edit</li>
                                                        <li>remove</li>
                                            ...
                                            <h4>global techonologies</h4>
                                            <h5>barry cuda</h5>
                                            <h6>ceo</h6>
                                            <h3><a href="{{ route ('chat.index') }}">message</a><a href="#">view profile</a></h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6 col-md-3">
...
<script type="text/javascript" src="{{asset('backend/assets/js/allHotelPage.js')}}"></script> <!--===== custom js link =====-->
@endpush